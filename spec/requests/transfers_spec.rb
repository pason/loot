...
RSpec.describe 'Transfers API' do
  ...
  describe 'GET /users/:user_id/transfers' do
    before { get "/users/#{user_id}/transfers" }
  ...
  describe 'GET /users/:user_id/transfers/:id' do
    before { get "/users/#{user_id}/transfers/#{id}" }
  ...
  describe 'POST /users/:user_id/transfers' do
    ...
    context 'when request attributes are valid' do
      before { post "/users/#{user_id}/transfers", params: valid_attributes }
    ...
    context 'when an invalid request' do
      before { post "/users/#{user_id}/transfers", params: {account_number_from: '00'} }
  ...
  describe 'PUT /users/:user_id/transfers/:id' do
    ...
    before { put "/users/#{user_id}/transfers/#{id}", params: valid_attributes }
  ...
  describe 'DELETE /users/:id' do
    before { delete "/users/#{user_id}/transfers/#{id}" }
